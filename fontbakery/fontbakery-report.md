 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: tifinagh, malayalam, tai-le, syriac, coptic, canadian-aboriginal, math, old-permic
...
Your font does *not* cover the following languages that require the soft-dotted feature: Ejagham (Latn, 120,000 speakers), Navajo (Latn, 166,319 speakers), Avokaya (Latn, 100,000 speakers), Nateni (Latn, 100,000 speakers), Sar (Latn, 500,000 speakers), Kom (Latn, 360,685 speakers), Ma’di (Latn, 584,000 speakers), Koonzime (Latn, 40,000 speakers), Lugbara (Latn, 2,200,000 speakers), Mango (Latn, 77,000 speakers), Basaa (Latn, 332,940 speakers), Dan (Latn, 1,099,244 speakers), Igbo (Latn, 27,823,640 speakers), Gulay (Latn, 250,478 speakers), Aghem (Latn, 38,843 speakers), Ebira (Latn, 2,200,000 speakers). [code: soft-dotted]
